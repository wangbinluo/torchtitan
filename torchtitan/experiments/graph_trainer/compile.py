...
def _get_reshard_policy(
    parallelism: ParallelismConfig, parallel_dims: ParallelDims
) -> bool:
    """Resolve fsdp_reshard_after_forward policy to a boolean."""
...
def apply_compile(
    ...
    *,
    ...
    Args:
        ...
        transformer_block_buckets: Module buckets for transformer_block_bucketing pass
    """
    ...
    fsdp_reshard_after_forward = _get_reshard_policy(parallelism, parallel_dims)
